    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          s.HeightSpace(18),
          _Basicsrow(title: "Full Name", subtitle: "Abu Bin Ishtiyak"),
          s.HeightSpace(10),
          _Basicsrow(title: "Display Name", subtitle: "Ishtiyak"),
          s.HeightSpace(10),
          _Basicsrow(title: "Email", subtitle: "info@englms.com"),
          s.HeightSpace(10),
          _Basicsrow(title: "Phone Number", subtitle: "Not add yet"),
          s.HeightSpace(10),
          _Basicsrow(title: "Date of Birth", subtitle: "29 Feb, 1986"),
          s.HeightSpace(10),
          _Basicsrow(title: "Nationality", subtitle: "Canadian"),
          s.HeightSpace(10),
          _Basicsrow(
              title: "Address",
              subtitle: "2337 Kildeer Drive,Kentucky, Canada"),
          s.HeightSpace(18),
        ],
      ),
    );
